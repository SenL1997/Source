...
/**
 * This class is modified from {@link android.nfc.cardemulation.HostApduService}
 *
...
public abstract class CustomHostApduService extends Service {
    ...
    /**
     * The {@link android.content.Intent} action that must be declared as handled by the
     * service.
     */
     ...
     * case {@link #processCommandApdu(byte[], android.os.Bundle)} will be called again.
     */
     ...
     * {@link #processCommandApdu(byte[], android.os.Bundle)} call and a
     ...
     *
     * @param reason Either {@link #DEACTIVATION_LINK_LOSS} or
     ...
     * null will be sent.
     *
     * @param serverMessenger Either local messenger of {@link NfcServerSocket} or null
     */
